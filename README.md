#Brandon Niles Pencil kata
## Note:
**This Kata was not done following TDD practices and is not intended for submission for review**
- This was simply completed to prove to myself that it could in fact be completed.  
- It was completed as quick as possible. While there was a bit of refactoring, the developer is certainly aware that there can be more refactoring done.
...
1. clone the repo and cd into the main project directory.
2. run `rake run`
